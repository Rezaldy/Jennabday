  ...
  <q-layout view="lHh Lpr lFf">
    ...
    <q-header elevated>
      <q-toolbar>
        ...
        <transition v-if="progress === 100" appear enter-active-class="animated fadeIn" leave-active-class="animated fadeOut">
          <div>
            <q-btn
              flat
              dense
        ...
        <q-linear-progress transition-show="fade" transition-hide="fade" v-else class="progress" stripe size="20px" :value="progress / 100" style="width:150px">
          <div class="absolute-full flex flex-center">
            <q-badge color="white" text-color="accent" :label="progress + '%'" />
          </div>
        </q-linear-progress>
        <div class="lost cursor-pointer" @click="lost('top')">I'm lost</div>
      </q-toolbar>
    </q-header>
